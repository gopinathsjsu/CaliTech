...
export default class Pickseat  extends Component {
  ...
  render() {
    const rows = [
      [{id: 1, number: 1, isSelected: false}, {id: 2, number: 2, isSelected: false,}, {id: 3, number: '3', isReserved: false, orientation: 'east'}, {id: 4, number: '4', orientation: 'west'}, null, {id: 5, number: 5}, {id: 6, number: 6}],
